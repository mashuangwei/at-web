<template>
    <div>
        <Tabs :value="commonTablsName">
            <TabPane label="jenkins服务器" name="jenkins服务器" icon="ios-paper-outline">
                <Card>
                    <p slot="title">
                    ...
                    <Form ref="searchProjectName" :model="searchProjectName" :label-width="80" style="margin-top: 13px;margin-left: -50px">
                        <FormItem label="" prop="name">
                            <Input v-model="searchProjectName.name" style="width: 270px;margin-left: -20px" placeholder="请输入Jenkins名称"></Input>
