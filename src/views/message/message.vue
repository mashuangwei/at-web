...
export default {
    ...
    methods: {
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = '线上回归测试已完成，请查看详细报告'; break;
                case 'unread1': mesContent = '冒烟测试已完成，请查看详细报告'; break;
                case 'unread2': mesContent = '核心支付测试已完成，请查看详细报告'; break;
                case 'hasread0': mesContent = '计费系统测试已完成，请查看详细报告'; break;
                default: mesContent = '集成测试已完成'; break;
            }
    ...
    mounted () {
        this.currentMesList = this.unreadMesList = [
            {
                title: '线上回归测试已完成，请查看详细报告',
                time: 1537349106000
            },
            {
                title: '冒烟测试已完成，请查看详细报告',
                time: 1529990106000
            },
            {
                title: '核心支付测试已完成，请查看详细报告',
                time: 1537390106000
            }
        ];
        this.hasreadMesList = [
            {
                title: '计费系统测试已完成，请查看详细报告',
                time: 1507330106000
            }
        ];
        this.recyclebinList = [
